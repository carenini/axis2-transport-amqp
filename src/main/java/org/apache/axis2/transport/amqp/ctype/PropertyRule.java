...
*/
package org.apache.axis2.transport.amqp.ctype;
...
public class PropertyRule implements ContentTypeRule {
    ...
    public ContentTypeInfo getContentType(Message message) throws AmqpException {
        String value = message.getMessageProperties().getContentType();
