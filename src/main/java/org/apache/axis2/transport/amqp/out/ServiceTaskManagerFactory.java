...
public class ServiceTaskManagerFactory {
	...
	public static ServiceTaskManager createTaskManagerForService(AMQPConnectionFactory jcf, AxisService service, WorkerPool workerPool) {
		...
		stm.setSubscriptionDurable(getOptionalBooleanProperty(AMQPConstants.PARAM_SUB_DURABLE, svc, cf));
		stm.setDurableSubscriberName(getOptionalStringProperty(AMQPConstants.PARAM_DURABLE_SUB_NAME, svc, cf));
