...
public class AMQPMessageSender {
     ...
     */
    public AMQPMessageSender(Connection connection, Session session, MessageProducer producer,
     ...
     */
    public AMQPMessageSender(AMQPConnectionFactory jmsConnectionFactory, String targetAddress) {
        ...
        this.destination =
            jmsConnectionFactory.getSharedDestination() == null ?
                jmsConnectionFactory.getDestination(AMQPUtils.getDestination(targetAddress),
    ...
    public void send(Message message, MessageContext msgCtx) {
        ...
        Boolean persistent   = getBooleanProperty(msgCtx, AMQPConstants.JMS_DELIVERY_MODE);
        Integer priority     = getIntegerProperty(msgCtx, AMQPConstants.JMS_PRIORITY);
        Integer timeToLive   = getIntegerProperty(msgCtx, AMQPConstants.JMS_TIME_TO_LIVE);
        ...
        try {
            ...
            try {
                ...
                if (msgId != null) {
                    msgCtx.setProperty(AMQPConstants.JMS_MESSAGE_ID, msgId);
                }
